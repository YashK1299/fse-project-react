...
const Tuit = ({ tuit, deleteTuit, likeTuit, dislikeTuit, bookmarkTuit, inBookmarksPage, unbookmarkTuit }) => {
  ...
  return (
    ...
    <li className="p-2 ttr-tuit list-group-item d-flex rounded-0">
      ...
      <div className="pe-2">
        {
          tuit.postedBy &&
            ...
            <img alt='' src={`../images/${(tuit.postedBy.username) ? tuit.postedBy.username : "react"}.jpg`}
      ...
      <div className="w-100">
        ...
        <TuitStats tuit={tuit} likeTuit={likeTuit} dislikeTuit={dislikeTuit} bookmarkTuit={bookmarkTuit} inBookmarksPage={inBookmarksPage} unbookmarkTuit={unbookmarkTuit} />
      </div>
    </li>
  );
}
